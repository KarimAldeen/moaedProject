...
function LayoutModal({ size, isAddModal, headerText, handleSubmit = () => { }, getInitialValues, getValidationSchema, status, children }: LayoutModalProps) {
  ...
  return (
    <Modal centered isOpen={isAddModal ? isOpenAddModel : isOpenEditModel} size={size ?? "lg"} >
